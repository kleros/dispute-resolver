...
class Summary extends React.Component {
  ...
  render() {
    const { primaryDocument, awaitingConfirmation, show, activeAddress, subcourtsLoading, subcourtDetails, onReturnButtonClickCallback } = this.props;
    ...
    return (
      <div className={styles.Summary}>
        <Form noValidate validated={validated} onSubmit={this.onModalShow}>
          ...
          <Button type="button" className={styles.submit} onClick={onReturnButtonClickCallback}>
            Return
          </Button>
        </Form>
      </div>
