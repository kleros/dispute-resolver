...
class App extends React.Component {
    ...
    getArbitrableDisputeID = async (arbitratorDisputeID) =>
        EthereumInterface.call("BinaryArbitrableProxy", networkMap[this.state.network].BINARY_ARBITRABLE_PROXY, "externalIDtoLocalID", arbitratorDisputeID);
    ...
    getCrowdfundingStatus = async (arbitrableDisputeID) =>
        EthereumInterface.call("BinaryArbitrableProxy", networkMap[this.state.network].BINARY_ARBITRABLE_PROXY, "crowdfundingStatus", arbitrableDisputeID, this.state.activeAddress);
    ...
    withdrawFeesAndRewardsForAllRounds = async (arbitrableDispute) =>
        this.interactWithBinaryArbitrableProxy("send", "0", "withdrawFeesAndRewardsForAllRounds", arbitrableDispute, this.state.activeAddress);
    ...
    appeal = async (arbitrableDisputeID, party, contribution) =>
        EthereumInterface.send("BinaryArbitrableProxy", networkMap[this.state.network].BINARY_ARBITRABLE_PROXY, this.state.activeAddress, contribution, "fundAppeal", arbitrableDisputeID, party);
    ...
    getEvidences = async (arbitrableAddress, arbitrableDisputeID) =>
        await this.state.archon.arbitrable.getEvidence(arbitrableAddress, networkMap[this.state.network].KLEROS_LIQUID, arbitrableDisputeID);
        ...
        if (!network || !activeAddress)
            return (
                <Container fluid="true" style={{ position: "relative" }}>
                    ...
                    <Footer
                        ...
                        contractExplorerURL={`https://${this.ETHERSCAN_STRINGS[1]}etherscan.io/address/${networkMap[1].BINARY_ARBITRABLE_PROXY}#code`}
            ...
            return (
                <Container fluid="true" style={{ position: "relative", minHeight: "100vh" }}>
                    ...
                    <Footer
                        appName="Dispute Resolver"
                        contractExplorerURL={`https://${this.ETHERSCAN_STRINGS[this.state.network]}etherscan.io/address/${networkMap[this.state.network].BINARY_ARBITRABLE_PROXY}#code`}
